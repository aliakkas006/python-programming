...
class Student(Person):
    def __init__(self, name: str, email: str, password: int, hobby: str, marital_status: bool, student_id: int, class_name: str, home_town: str):
    ...
    def __str__(self):
        return self.__name, self.__email, self.__password, self.hobby, self.is_married, self.student_id, self.class_name, self.home_town

    def __repr__(self):
        return self.__name, self.__email, self.__password, self.hobby, self.is_married, self.student_id, self.class_name, self.home_town


instance_2 = Student("Anis", "anis@gmail.com", 12354678, "tour", False, 254785, "b.pharma", "Chandpur")
